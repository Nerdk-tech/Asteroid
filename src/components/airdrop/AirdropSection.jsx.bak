              ...
              <AnimatePresence mode="wait">
                ...
                {!walletAddress && (
                  <motion.div key="connect" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="text-center">
                    ...
                    <Button onClick={onConnect} className="w-full bg-primary text-primary-foreground hover:bg-primary/90 font-space font-bold h-12 text-sm rounded-xl shadow-lg shadow-primary/25 hover:shadow-primary/40 transition-all">
                      <Wallet className="w-4 h-4 mr-2" /> Connect Wallet
                    </Button>
                    <p className="text-[10px] text-muted-foreground/40 mt-3">MetaMask · WalletConnect · Coinbase Wallet</p>
                  </motion.div>
                )}
